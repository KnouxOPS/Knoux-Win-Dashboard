...
// Helper to map icons to sections (simulating specific icons)
...
export const Sidebar: React.FC<SidebarProps> = ({ sections, activeSectionId, onSelectSection }) => {
  return (
    <div className="w-64 bg-bg-panel flex flex-col h-full shrink-0 border-r border-white/[0.05] z-20 shadow-xl">
      {/* Branding Area matching screenshot top-left */}
      ...
      <div className="flex-1 overflow-y-auto py-6 flex flex-col gap-2">
        ...
        <button className="flex items-center gap-4 px-6 py-3 text-sm text-text-sub hover:text-white hover:bg-white/[0.02] transition-colors">
